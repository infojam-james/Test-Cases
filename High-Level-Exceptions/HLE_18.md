...
#High Severity: Do not send notification if 'x' button clicked

##Description
No High-Level Alert email should be sent if a case is flagged as High Severity, but the 'x' button is clicked instead of the 'Save Changes' button
