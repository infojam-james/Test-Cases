...
##Description
The 'Educational Visits Critical Incident Checklist' should become available to health & safety system administrators when an incident concerning a fatality is recorded.
...
4 Select 'Open Educational Visits Critical Incident Checklist'

##Expected Results
+ A new browser window should open containing the Educational Visits Critical Incident Checklist
